...
// 2. Update the projects array to use the imported image objects
const projects = [
  {
    name: "Discount Wheel",
    description:
    ...
    image: accessibility, // Use the imported object
              ...
              <SlideUp offset="-300px 0px -300px 0px">
                <div className="flex flex-col animate-slideUpCubiBezier animation-delay-2 md:flex-row md:space-x-12">
                  <div className="md:w-1/2">
                    <Image
                      src={project.image} // This now uses the imported image object
                      alt={project.name} // Added alt text for accessibility
                      width={1000}
                      height={1000}
